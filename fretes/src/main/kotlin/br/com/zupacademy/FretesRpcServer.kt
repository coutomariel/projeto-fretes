...
@Singleton
class FretesRpcServer : FretesServiceGrpc.FretesServiceImplBase() {

    private val logger = LoggerFactory.getLogger(FretesRpcServer::class.java)
...
//
        if (!cep!!.matches("[0-9]{5}-[0-9]{3}".toRegex())) {
            val e = Status.INVALID_ARGUMENT
                ...
                .augmentDescription("Cep precisa respeitar o formado 99999-999")
                .asRuntimeException()
        ...
        try {
            ...
            if (valor > 100) {
                throw IllegalArgumentException("Erro inesperado no sistema com valor: $valor")
            }
